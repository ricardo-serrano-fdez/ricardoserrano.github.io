"""Detect edges of tile and classify them into city, road, or field.

Break each edge into 3 parts, a tile will look like this
           N1   |   N2   |   N3 
       --------------------------
      |                          |
 W1   |                          |  E1
...
def classify_edges(image: np.ndarray,corners:list[int]):
    """Classify the edge of a tile as city, road, or field.

    Args:
        image: The image of the tile edge to classify.
        corners: A list of corner coordinates for the tile.
    """

def detect_corners(image: np.ndarray) -> list[int]:
    """Detect the corners of a tile in an image.

    Args:
        image: The image of the tile to detect corners in.

    Returns:
        A list of corner coordinates for the tile.
    """
