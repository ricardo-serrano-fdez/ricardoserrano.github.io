...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.35923183633813281697521537744486885300`
...
### Source Raw Report:
```text
[DATE]: * MR Knie Links 15ch AA Klinische Inlichtingen: Persisterende pijn knie kuit links. Diagnostische vraagstellling: Evaluatie. Scan protocol (DRB) : intermediair gewogen seq met fs in de 3 richtingen, cor T1 gewogen seq , sag intermediair gewogen seq Bevindingen:
```
