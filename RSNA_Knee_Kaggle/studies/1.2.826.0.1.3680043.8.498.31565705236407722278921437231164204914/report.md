...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.31565705236407722278921437231164204914`
...
### Source Raw Report:
```text
SOL  DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Medial menisküs ve lateral menisküs normaldir.Ön çapraz bağda , arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps normaldir. Patella normal yerleşimlidir.Retinaküler devamsızlık yoktur.Gastrokinemius medial kurus tendonunda femur yapışma yeri düzeyinde parsiyel yırtık ve komşuluğunda lobule konturlu yaklaşık 18x9 mm boyutlarında ganglion kisti izlendi. Diz eklemi içerisinde sıvı artışı izlenmedi.
```
