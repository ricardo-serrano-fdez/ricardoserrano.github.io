...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.61981891095235024266625598999854298547`
...
### Source Raw Report:
```text
ΤΕΧΝΙΚΗ: Η εξέταση έγινε µε ακολουθίες παλµών Τ1, FS PD και T2* σε τρία επίπεδα. ΕΥΡΗΜΑΤΑ - Αναγνωρίζεται ελάχιστη ενδαρθρική συλλογή υγρού. - Ελέγχεται περιοχή αυξηµένης έντασης σήµατος στην κατάφυση του τένοντα του τετρακεφάλου, ως επί µερικής ρήξης/τενοντοπάθειας αυτού. - Παρουσία χόνδρινου ελλείµµατος εύρους 8mm στην παρυφή της έξω αρθρικής επιφάνειας της επιγονατίδας, ως επί χόνδρινης κάκωσης. Μορφολογία επιγονατίδας Wiberg τύπου 2. - ∆εν αναγνωρίζονται παθολογικά ευρήµατα από τους χιαστούς και πλάγιους συνδέσµους. - Φυσιολογικά ελέγχονται οι µηνίσκοι. - Σηµειώνεται οιδηµατώδης απεικόνιση και υγρική διαπότιση των µαλακών µορίων πρόεππιγονατιδικά. - Με σήµα εντός του φυσιολογικού ελέγχεται ο οστικός µυελός.
```
