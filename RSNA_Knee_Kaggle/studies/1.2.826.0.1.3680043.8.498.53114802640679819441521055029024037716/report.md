...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.53114802640679819441521055029024037716`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs discoid görünümde olup   grade II dejenerasyon izlendi. Medial menisküs grade III dejenerasyon ve horizontal yırtık izlendi.Ön çapraz bağ ve arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Suprapatellar bursada ve diz ekleminde sıvı artışı izlendi.Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.Gastroknemius medial bacağında parsiyel yırtık, kas içi ve komşu yapılarda sinyal artışı ve ödematöz görünüm mevcuttur(grade II strain).
```
