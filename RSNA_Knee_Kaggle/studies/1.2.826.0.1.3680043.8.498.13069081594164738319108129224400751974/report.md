...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.13069081594164738319108129224400751974`
...
## IMPRESSION:
1.	Нормално изобразяване на лявата колянна става.

---
### Source Raw Report:
```text
МР находка: Няма данни за ставен излив. Костите, формиращи лявата колянна става, са с нормална форма, структура и сигнален интензитет. Липсват зони на костномозъчен едем. Менискусите са хомогенно анинтенсни, без патологични изменения. Нормално изобразяване на кръстните връзки. Ставният хрущял на тибията и фемура е интактен, със запазена конгруентност. Колатерални лигаменти - б.о. Ретинакулуми – б.о. 
Патела, хрущял на пателата – б.о. Нормално изобразяване на меките тъкани. 
Заключение:  Нормално изобразяване на лявата колянна става.
```
