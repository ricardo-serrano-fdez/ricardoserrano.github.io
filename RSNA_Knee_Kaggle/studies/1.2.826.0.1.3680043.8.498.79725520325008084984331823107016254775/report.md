...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.79725520325008084984331823107016254775`
...
### Source Raw Report:
```text
Técnica: RMN de la rodilla. Resultados: lesión del menisco interno, no se puede descartar un desgarro. Impresión: lesión del menisco interno, no se puede descartar un desgarro,
```
