...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.89943815722422273305517145510644432987`
...
### Source Raw Report:
```text
MRI of knee in sagittal section (Proton density with fat suppression, T1WI, T2WI with fat suppression), axial section (T2WI with fat suppression) and coronal section (T2WI with fat suppression):

* Blurred contour of the posterior cruciate ligament (PCL) near its femoral insertion site is noticed, r/o partial tear of PCL.
...
Impression: R/O partial tear of PCL 
