...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.89110271437785174288044757208973128908`
...
### Source Raw Report:
```text
There is normal knee joint alignment. No fracture or bone contusion is noted. 
  Normal ACL orientation with intact ligament fiber is observed. PCL is intact.  
  
  Normal MCL is seen. Normal shape with preserved signal of medial meniscus is observed. 
  FCL, popliteus and biceps femoris tendons are preserved.   
  Horizontal tear at lateral meniscus; anterior horn extended to meniscal body, with parameniscal cyst, about intact3x1.1cm. , noted.    
  PF joint is preserved.   No osteochondral lesion is detected. 
   Minimal joint effusion is seen. 
  Quadriceps and patellar tendons are preserved.    Horizontal tear at lateral meniscus; anterior horn extended to meniscal body, with parameniscal cyst, about intact3x1.1cm.
```
