...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.29055892482211392922525222851162308510`
...
### Source Raw Report:
```text
Both menisci show normal signal intensity and there are intact. Cruciate and collateral ligaments are normal. The bony texture is normal and the patello-femoral joint is unremarkable.
```
