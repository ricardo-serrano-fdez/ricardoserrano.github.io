...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.11871142388984150456249558619289234011`
...
### Source Raw Report:
```text
The study reveals anterior tibial translation. No fracture is detected.   
  Mild focal bone marrow edema at posterior lateral proximal tibia is observed.  
  Complete loss of entire of the  ACL is observed.   PCL is intact.  
  MCL is intact.    Small oblique vertical tear at posterior horn of the medial meniscus with partial tear at posterior root, are detected.    
    FCL and popliteus tendon are preserved. Biceps femoris tendon is preserved.   
 Lateral meniscus is not torn.   
    PF joint and joint surface are preserved.  Medial and lateral patellar retinacula are preserved. 
    Quadriceps and patellar tendons are intact.   - Chronic complete tear  ACL,  
  - Small oblique vertical tear at posterior horn of the medial meniscus with partial tear at posterior root,
```
