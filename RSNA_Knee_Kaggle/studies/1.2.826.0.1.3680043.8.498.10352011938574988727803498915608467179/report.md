...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.10352011938574988727803498915608467179`
...
The study reveals normal knee joint alignment.   No fracture or bone contusion is seen.  
  ...
  Normal appearance of articular cartilage at the medial and lateral patellar facet without cartilaginous detected is detected.  No subchondral bone lesion is observed.  Minimal PF joint fluid is seen. 
  Medial and lateral patellar retinacula are preserved.     
  The quadriceps and patellar tendons are intact.  
  
  MCL is intact.   Normal shape with preserved signal of medial meniscus is observed. 
  FCL, popliteus and biceps femoris tendons are preserved.  Lateral meniscus is not torn. 
   Normal ACL orientation with intact ligament fiber is observed.  The PCL is intact.  
  No definite osteochondral lesion is noted. 
    Minimal PF joint effusion is seen.  No definite cartilagenous lesion. 
  No definite meniscal tear detected.
```
