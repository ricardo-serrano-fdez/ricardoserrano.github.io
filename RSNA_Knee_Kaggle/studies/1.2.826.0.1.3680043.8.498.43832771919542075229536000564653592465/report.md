...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.43832771919542075229536000564653592465`
...
## IMPRESSION:
1.	s: 
1. In favor of PCL tear
2. Suprapatellar bursitis of left knee
...
* Blurred contour of posterior cruciate ligament (PCL) with increased signal intensity on T2WI is noticed, in favor of PCL tear.

* Fluid accumulation in the suprapatellar bursa of left knee is noticed, indicating suprapatellar bursitis.

> The contour of anterior cruciate ligament (ACL) appears to be within normal, no abnormal signal intensity is noted.
