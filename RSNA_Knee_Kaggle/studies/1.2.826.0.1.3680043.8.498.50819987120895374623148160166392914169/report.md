...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.50819987120895374623148160166392914169`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Medial menisküs posterior hornda grade III dejenerasyon ve horizontal yırtık izlendi.  Medial menisküs hafif ekstrude  görünümdedir. Lateral menisküs normaldir.  Ön çapraz bağ ve arka çapraz bağ, lateral kollateral ligaman normaldir.Medial kollateral ligamen hafif ödematöz görünümdedir ( grade I sprain ).Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Diz eklemini oluşturan diğer kemik yapıların sinyal intensiteleri doğaldır. Tibia medial plato düzeyinde subkondral ödem izlendi.Popliteus kas düzeyinde ödemle uyumlu sinyal artışı izlendi(Evre I-II strain).
```
