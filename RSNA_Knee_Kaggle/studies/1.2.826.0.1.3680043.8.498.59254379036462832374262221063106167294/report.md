...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.59254379036462832374262221063106167294`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs normaldir. Medial menisküs grade II dejenerasyon izlendi.Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir. Ön çapraz bağ sinyalinde hafif artış  izlendi.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.
```
