...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.11814923363609140180293604689814785969`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslıBulgular: Medial menisküs posterior hornunda grade II dejenerasyon uyumlu sinyal değişiklikleri mevcuttur.  Lateral menisküste grade II dejenerasyon ile uyumlu sinyal değişikliği izlenmiştir.Ön çapraz bağ ve arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Femur lateral epikondil düzeyinde subkondral milimetrik kistler izlenmektedir.Patellar kemikte eklem yüzeyi komşuluğunda subkondral milimetrik kistler ve patellar kemikte hafif kemik iliği ödemi izlenmektedir. Bu düzeyde patellar ve trchlear kıkırdakta belirgin kondromalazi izlendi.Eklemde sıvı artışı saptanmamıştır. Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.
```
