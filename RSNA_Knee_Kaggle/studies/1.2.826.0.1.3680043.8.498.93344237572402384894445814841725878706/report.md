...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.93344237572402384894445814841725878706`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular:Lateral menisküs ve medial menisküs normaldir. Lateral ve medial reseslerde sıvı artışı izlenmiştir.Ön çapraz bağ, lateral  kollateral ligaman normaldir. Medial kollateral ligaman çevresinde hafif sıvı artışı mevcuttur. Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Suprapatellar bursada ve diz ekleminde sıvı artışı izlendi(bursit ve sinovit).Diz eklemini oluşturan kemik yapılar doğaldır.
```
