...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.81631925197682464058124413934958934086`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs ve medial menisküs normaldir.  Ön çapraz bağ, lateral ve medial kollateral ligaman normaldir. Arka çapraz bağ posterior komşuluğunda büyüğü 17x9 mm boyutlarında ganglion kistleri izlenmiştir. Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Fermur interkondiler düzey ve lateral kondil düzeyinde anteriorda subkondral kemik iliği ödemi ile uyumlu görünüm mevcuttur.
```
