...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.62437671010172828772205139640126159272`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Medial menisküste grade III dejenerasyon, lateral menisküste grade II dejenerasyon izlenmiştir.Arka çapraz bağ, lateral kollateral ligaman normaldir. Ön çapraz bağda miksoid dejenerasyon ile uyumlu sinyal artışı izlendi. MCL de grade I sprain izlendi.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Suprapatellar bursada diz eklemi içerisinde sıvı artışı izlenmiştir. Medial ve lateral reseslerde sıvı artışı izlenmiştir.Diz eklemi düzeyinde çevre yağlı doku planlarında belirgin ödematöz görünüm mevcuttur.Femur interkondiler düzey anteriorda 10x3.5 mm boyutta osteokondral defekt izlendi.
```
