...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.13267708980958529833316446819156908381`
...
### Source Raw Report:
```text
Η εξέταση έγινε µε ακολουθίες παλµών PD, fs PD, T1 και Τ2*. Από τον έλεγχο του πρόσθιου και έξω διαµερίσµατος, δεν παρατηρούνται αξιόλογα ευρήµατα. Στο έσω διαµέρισµα του γόνατος, αναγνωρίζεται παοθλογικό σήµα και µορφολογία καθώς και υπεξάρθρηµα του µηνίσκου, παρουσία επιχείλιων οστεοφύτων, διάβρωση αρθρικού χόνδρου σε µηριαίο κόνδυλο και κνηµιαίο κόνδυλο (ICRS stage III), και υπαρθρικό οστεοµυελικό οίδηµα στην κνήµη. Τα ευρήµατα συνηγορούν για εκφυλιστική οστεοαρθρίτιδα έσω διαµερίσµατος µε εκφυλιστική ρήξη του µηνίσκου, και µικροδοκιδώδες κάταγµα ανεπάρκειας, στην υπαρθρική µοίρα της κνήµης σύστοιχα. Τα συνδεσµικά στοιχεία είναι ακέραια. Ενδαρθρικά παρατηρούνται µικρά ξένα σώµατα.
```
