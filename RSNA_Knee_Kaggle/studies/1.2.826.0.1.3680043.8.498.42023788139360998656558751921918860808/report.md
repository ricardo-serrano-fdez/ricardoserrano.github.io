...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.42023788139360998656558751921918860808`
...
### Source Raw Report:
```text
Nach stattgehabter Patellaluxation entsprechendes Knochenmarködem am lateralen Femurcondylus sowie der Patella medialseitig. Dejour A (ca. 140°), Wiberg II/III. Caton-Deschamps-Index 1,3, somit grenzwertig für eine Patella alta. Keine relevanten Degenerationen. Kein Hinweis auf eine Fraktur. Keine höhergradige Chondropathie femoropatellar und femorotibial. V.a. Partialläsion des MPFL (4/13). Flüssigkeit angrenzend an das MCL bei Bandintegrität. Vorderes und hinteres Kreuzband sowie LCL intakt. Quadrizeps- und Patellarsehne intakt ohne Signalalteration. Regelrechte Konfiguration der Menisken ohne H.a. Rissbildung. Hämarthros. 1,6 cm messende Bakerzyste. Subcutane Flüssigkeitseinlagerungen/Einblutungen ventralseitig.
```
