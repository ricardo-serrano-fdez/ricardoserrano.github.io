...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.76514504104121634569792846980451896030`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs normaldir.  Medial menisküs posterior hornunda yırtık ile uyumlu devamsızlık mevcuttur. Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.ACL'de parsiyel rüprütü düşündüren devamsızlık bulguları izlenmektedir. Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Diz eklem kapsülünde ve suprapatellar bursada sıvı artışı bulguları saptanmıştır. Tibial end-platoda interkondiler alanda subkondral kemik iliği ödemi bulguları saptanmıştır. Femur medial kondilde subkondral kemik iliği ödemi saptanmıştır.
```
