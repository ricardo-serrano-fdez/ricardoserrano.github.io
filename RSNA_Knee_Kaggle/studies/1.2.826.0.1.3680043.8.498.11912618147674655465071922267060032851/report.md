...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.11912618147674655465071922267060032851`
...
### Source Raw Report:
```text
[DATE]: * MR Knie Links 15ch AA : Klinische Inlichtingen : Trauma. Diagnostische vraagstellling : Voorste kruisband letsel ? Scanprotocol (DRB) : sag intermediair gewogen seq zonder en met fs, ax/ cor pd gewogen seq fs, cor T1 gewogen seq Bevindingen: -Status na doorgemaakte patellaluxatie met hooggradige sprain
```
