...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.13660439785395658826946769630921591235`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs ve medial menisküs normaldir.  Ön çapraz bağ ve arka çapraz bağ, lateral  kollateral ligaman normaldir.Medial kollateral ligamenda grade II sprain ile uyumlu sinyal değişiklikleri mevcuttur. Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklem mesafesinde ve suprapatellar bursada minimal effüzyon izlendi.Femur medial kondilinde posteriorda dejeneratif subkondral kistler izlendi.Tetkike dahil kesimde diğer kemik yapıların sinyal intensiteleri doğaldır.
```
