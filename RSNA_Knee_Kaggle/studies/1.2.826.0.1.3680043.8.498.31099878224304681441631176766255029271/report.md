...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.31099878224304681441631176766255029271`
...
### Source Raw Report:
```text
Técnica: RMN de la rodilla. Resultados: Cambios en el menisco externo, probablemente relacionados con un desgarro. Impresión: Cambios en el menisco externo, probablemente relacionados con un desgarro.
```
