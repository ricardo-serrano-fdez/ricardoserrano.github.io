...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.73325959289998105909842627876607163467`
...
Regelrechtes Knochenmarksignal. Intakter Knorpel. Intakter Innenmeniskus. Intaktes MCL.

Laterales Kompartiment:
Geringes Bone-bruise im posterolateralen Tibiaplateau. Ansonsten regelrechtes Knochenmarksignal. Intakter Knorpel. Intakter Außenmeniskus. Proximal deutlich aufgefasertes und signalalteriertes LCL (Serie 5/ Image 22, Serie 4/ Image 16).

Femoropatellares Gleitlager und Trochlea:
Regelrechtes Knochenmarksignal. Intakter Knorpel. Regelrechte Darstellung der Quadrizeps- und Patellarsehne. Regelrechte Darstellung des Hoffa`schen Fettkörpers.

Kreuzbänder:
Vollständige Ruptur des VKB. Intaktes HKB.

Muskulatur und übrige Weichteile:
Ausgedehnter Hämarthros. Kleine Plica mediopatellaris (Typ A nach Sakakibara).
```
