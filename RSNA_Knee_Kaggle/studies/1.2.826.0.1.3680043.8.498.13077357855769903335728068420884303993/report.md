...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.13077357855769903335728068420884303993`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Medial menisküs posterior hornda grade II dejenerasyon izlenmiştir. Lateral menisküs  normaldir.  ACL sinyal kalınlığı artmıştır ( parsiyel rüptür ).Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Suprapatellar bursada artmış efüzyon izlenmiştir.
```
