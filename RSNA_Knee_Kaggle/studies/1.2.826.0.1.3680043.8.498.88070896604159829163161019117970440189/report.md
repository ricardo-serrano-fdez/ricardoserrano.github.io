...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.88070896604159829163161019117970440189`
...
-Sag PD FS, Sag T2 FS, 3-Plane Loc, Sag T1, Cor T2 FS, Ax T2 FS

> Interstitial increased signal intensity of LCL with perifocal thin layer hyperintensity area between LCL and popliteus tendon and joint capsule, in favor of grade 1 LCL injury and mild LCL bursitis.  
> The contour of ACL & PCL and MCL appear to be within normal, no abnormal signal intensity is noted.
> No evidence of tear is noted in either medial or lateral meniscus.
> No evidence of bone contusion is noted.
> Suspicious of mild thining of lower portion of lateral facet of patellar cartilage, R/O grade 2 patellar chondromalacia.
> Minimal  joint joint effusion
Impression: 
1. R/O Grade 1 LCL injury and mild LCL bursitis. 
2. R/O grade 2 patellar chondromalacia.
