...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.88962401400598535739494671683916272476`
...
## IMPRESSION:
1.	s: 
1. A small eccentric intramedullary lesion in the posterior portion of distal femur, nature to be determinated
2. No other significant abnormal finding in this MRI
...
### Source Raw Report:
```text
MRI of right knee in sagittal section (Proton density with fat saturation, T1WI, T2WI with fat saturation), axial section (T2WI with fat saturation) and coronal section (T2WI with fat saturation):

* There is a small eccentric intramedullary lesion in the posterior portion of distal femur, nature to be determinated, r/o bone marrow reconversion, chondromyxoid fibroma.
