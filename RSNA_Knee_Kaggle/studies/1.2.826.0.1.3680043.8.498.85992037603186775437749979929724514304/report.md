...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.85992037603186775437749979929724514304`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Medial menisküs posterior hornda grade III dejenerasyon ve gövde kesimine uzanan kompleks yırtık izlendi. Medial menisküs mediale doğru hafif ekstrude görünümdedir. Lateral menisküs normaldir.  Ön çapraz bağ ve arka çapraz bağ, lateral kollateral ligaman normaldir.Medial kollateral ligamen hafif ödematöz görünümdedir  ( grade I sprain  ).Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Femur lateral kondil posteriorda subkondrial milimetrik kist izlendi.
```
