...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.52067134682915759489080529708019359378`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs grade II dejenerayon izlendi. Medial menisküs grade II dejenerasyon izlendi.Ön çapraz bağ sinyali miksoid dejenerasyon ile uyumlu artmıştır. Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır. Femur lateral kondil düzeyinde 4 mm çapta T1-T2 hipointens sklerotik kemik adacığı izlendi.Popliteal fossada 23x8 mm boyutlarında baker kisti izlendi.
```
