...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.74939269621045823332837094516056211606`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular:Lateral menisküs ve medial menisküs normaldir. Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Ön çapraz bağda diffüz hafif sinyal artışı izlenmiştir (minimal mukoid dejenerasyon?).Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Prepatellar bursada hafif ödem ile uyumlu sinyal değişikliği izlenmiştir. Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.Cilt altı yağlı dokuda variköz venöz oluşumlar görülmüştür. Popliteal bölgede 1 cm çaplı Baker izlenmiştir. SONUÇ: Prepatellar bursit, cilt altı variköz venöz oluşumlar, ACL'de mukoid dejenerasyon.
```
