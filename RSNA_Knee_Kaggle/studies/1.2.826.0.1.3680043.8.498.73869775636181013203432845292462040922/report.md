...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.73869775636181013203432845292462040922`
...
### Source Raw Report:
```text
ΤΕΧΝΙΚΗ Πραγµατοποιήθηκαν ακολουθίες PD, T1, T2. ΕΥΡΗΜΑΤΑ Φυσιολογική απεικόνιση αµφοτέρων των µηνίσκων. Χωρίς παθολογικά ευρήµατα ελέγχεται ο εκτατικός µηχανισµός. ∆εν σηµειώνονται παθολογικά ευρήµατα από τους χιαστούς και πλάγιους συνδέσµους καθώς και από τον αρθρικό χόνδρο. Μικρή συνοβιακή κύστη Baker παρατηρείται στην έσω ιγνυακή κοιλότητα. Συµπέρασµα Χωρίς αξιόλογα ευρήµατα.
```
