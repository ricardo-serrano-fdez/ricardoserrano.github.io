...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.13088550794087945662322609097092458487`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular:Medial menisküs posterior hornda yırtık saptanmıştır. Lateral menisküs normaldir.  PCL elonge görünümdedir. Sinyali normaldir. ACL anterior liflerde sinyal artışı izlenmiştir ( tendinozis  ). Lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Suprapatellar bursada hafif sıvı artışı bulguları izlenmiştir.
```
