...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.17420673628956367425739018933968443620`
...
### Source Raw Report:
```text
Regelrechte Artikulations- und Stellungsverhältnisse im Kniegelenk. Keine relevanten Degenerationen. Allseits regelrechtes Knochenmarksignal. Kein Hinweis auf eine Fraktur oder ein Bone-bruise. Keine höhergradige Chondropathie femoropatellar und femorotibial. Vorderes und hinteres Kreuzband sowie Kollateralbänder intakt. Quadrizeps- und Patellarsehne intakt ohne Signalalteration. Regelrechte Konfiguration der Menisken ohne H.a. Rissbildung. Akzentuierte Gelenkflüssigkeit, keine größere Ergussbildung. Unauffällige Darstellung der Weichteile.
```
