...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.12383716855639375235119728470042467411`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslıBulgular:Lateral menisküste grade II dejenerasyon ile uyumlu görünüm mevcuttur. Medial menisküs posterior hornunda grade II dejenerasyon uyumlu sinyal değişiklikleri mevcuttur.Ön çapraz bağ ve arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Femur distalinde interkondiller ve medial epikondil düzeyinde subkondral milimetrik kistler izlenmektedir. Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Patellar kemikte subkondral milimetrik kistler izlenmektedir. Patellar kondromalazi mevcuttur.
```
