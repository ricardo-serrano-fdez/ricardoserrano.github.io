...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.63320397279666280420359587173167195895`
...
### Source Raw Report:
```text
МР находка: МР данни за ставен излив. МР данни за костномозъчен едем в латерален кондул на фемура. Артикулиращия хрущял на фемура и на тибията е с нормална форма. Предна кръстна връзка се проследява до залавните си места и е с нормална форма. МР данни за лезия на медиален менискус – тип 1. Латерален менискус – с нормален МР образ. Нормално изобразяване на колатералните лигаменти. Ретинакулуми – без особености.
Лигамент на пателата и сухожилие на м. квадрицепс феморис – б.о. Нормално изобразяване на меките тъкани на лявото коляно. Заключение: МР данни за лезия на медиален менискус – тип 1. Ставен излив. Костномозъчен едем.
```
