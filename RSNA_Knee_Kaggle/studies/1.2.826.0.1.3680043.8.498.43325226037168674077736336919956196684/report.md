...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.43325226037168674077736336919956196684`
...
### Source Raw Report:
```text
MRI ΑΡΙΣΤΕΡΟΥ ΓΟΝΑΤΟΣ ΤΕΧΝΙΚΗ Η εξέταση έγινε µε ακολουθίες παλµών Τ1 πυκνότητας πρωτονίων µε καταστολή του σήµατος του λίπους και Τ2 βαθµιδωτής ηχούς. ΕΥΡΗΜΑΤΑ Στο έξω διαµέρισµα του γόνατος, σηµειούται απλή εκφύλιση, χωρίς ρήξη του µηνίσκου. Στο έσω διαµέρισµα του γόνατος, παρατηρείται εκφυλιστική ρήξη στο οπίσθιο κέρας του µηνίσκου και υπεξάρθρηµα αυτού. Επιπλέον παρατηρείται οστεοµυελικό οίδηµα σε έσω µηριαίο κόνδυλο και επικόνδυλο καθώς και διάβρωση του αρθρικού χόνδρου ICRS grade III τον έσω µηριαίο κόνδυλο και επικόνδυλο. Ενδαρθρική συλλογή υγρού επικοινωνεί µε συνοβιακή κύστη Baker κεφαλουραίας διαµέτρου 6,5cm στην έσω ιγνυακή κοιλότητα. Συµπέρασµα: Τα ευρήµατα συνηγορούν υπέρ κατάγµατος ανεπάρκειας (συνώνυµο της αυτόµατης οστεονέκρωσης) στον έσω µηριαίο κόνδυλο.
```
