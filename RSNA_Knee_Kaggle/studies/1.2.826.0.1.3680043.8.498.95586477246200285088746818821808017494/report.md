...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.95586477246200285088746818821808017494`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs normaldir.  Medial menisküs posterior hornunda menisküs kökü düzeyinde radial yırtık izlendi.ACL yapışma lokalizasyounda parsiyel yırtık ile uyumlu sinyal değişiklikleri mevcuttur.Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Suprapatellar ve prepatellar bursada minimal sıvı artışı mevcuttur. Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.
```
