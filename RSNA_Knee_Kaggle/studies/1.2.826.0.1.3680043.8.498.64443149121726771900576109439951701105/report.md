...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.64443149121726771900576109439951701105`
...
4.	Joint effusion.
5.	Popliteal (Baker's) cyst.

---
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs posterior horn grade III dejenerasyon, kova sapı yırtığı  izlendi. Lateral menisküs ekstrüde izlendi. Medial menisküs grade I dejenerasyon izlendi.Ön çapraz bağ ve arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Suprapatellar bursada ve diz eklemi içerisinde sıvı artışı izlendi.Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır. Tibia lateral plato düzeyinde tibiofemoral ekleme bakan yüzde subkondral hafif kemik iliği ödemi izlendi.Popliteal fossada 40x17 mm boyutta baker kisti izlendi.
```
