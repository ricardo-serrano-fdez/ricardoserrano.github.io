...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.70674155597869824035214737999044110827`
...
Indication: Compressible
Comparison: No relevant prior studies available for comparison.

TECHNIQUE:
MRI of the     knee was performed on a     system with a dedicated knee coil in three planes (axial, sagittal, and coronal), using a standard non-contrast protocol.
...
COLLATERAL LIGAMENTS & POSTEROLATERAL CORNER:
Medial collateral ligament (MCL): Mildly thickened with moderate surrounding edema consistent with grade 1 sprain.
Lateral collateral ligament (LCL) complex: Normal.
Posterolateral corner structures: Normal.
