...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.18848481788456572234982139368351538716`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs  normaldir.  Medial menisküs posterior hornunda kompleks yırtık ile uyumlu sinyal değişiklikleri izlenmiştir. Medial menisküs anterior hornunda grade I dejenerasyon izlendi.ACL  sinyal artışı mevcuttur. Bu alanda sıvı artışı izlenmiştir. Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.
```
