...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.16051798246004436152597344963060310360`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs normaldir.  Medial menisküs posterior hornunda kompleks yırtık ile uyumlu görünüm mevcuttur.Ön çapraz bağda  sinyal artışı mevcut olup düzensiz görünüm mevcuttur ( yırtık ).Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Tibia medial ve lateral platoları posterior düzeylerde subkondral kemik iliği ödemi mevcuttur. Femur distali medial kondil düzeyinde subkondral hafif kemik iliği ödemi izlenmektedir. Eklemde hafif sıvı artışı izlendi.Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.
```
