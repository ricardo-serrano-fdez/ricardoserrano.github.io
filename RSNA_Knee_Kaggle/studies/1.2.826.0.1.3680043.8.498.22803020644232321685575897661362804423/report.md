...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.22803020644232321685575897661362804423`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Medial menisküs posterior horn düzeyinde nonartiküler yüze açılan horizontal yırtık izlendi.Lateral menisküs  normaldir.  Ön çapraz bağ sinyali özellikle proksimalde sinyal artışı vardır (grade I sprain).  Arka çapraz bağ normaldir.Lateral ve medial kollateral ligaman normaldir.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Diz eklemi içerisinde hafif sıvı artışı izlenmiştir. Popliteal fossada yaklaşık 22x10 mm boyutlarında baker kisti izlendi.
```
