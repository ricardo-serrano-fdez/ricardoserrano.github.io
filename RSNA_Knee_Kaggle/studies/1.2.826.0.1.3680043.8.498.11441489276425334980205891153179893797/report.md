...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.11441489276425334980205891153179893797`
...
### Source Raw Report:
```text
SOL DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Femur lateral kondilinde kemik iliği ödemi dikkati çekmektedir. Tetkike dahil diz eklemini oluşturan diğer kemik yapıların korteks bütünlükleri, medüller sinyal intensiteleri doğaldır.Distal kuadriseps ve patellar tendonlar normaldir.Ön çapraz bağ ve arka çapraz bağ, lateral ve medial kollateral ligaman normaldir.Meniskal yapıların bütünlüğü sinyal intensitesi doğaldır. Eklem mesafesinde minimal efüzyon izlenmektedir.Popliteal fossada yer işgal eden lezyon saptanmadı.
```
