...
**StudyInstanceUID**: `1.2.826.0.1.3680043.8.498.72680485820462987585370556994612687540`
...
### Source Raw Report:
```text
SAĞ DİZ MRG. Tetkik protokolü: Çok düzlemli, çok sekanslı. Bulgular: Lateral menisküs normaldir. Medial menisküste grade III dejenerasyon eşlik eden  radial ve oblik yırtık ile uyumlu görünüm mevcuttur.Arka çapraz bağ, lateral ve medial kollateral ligaman normaldir. Ön çapraz bağda miksoid dejenerasyona bağlı sinyal artışı izlendi.Distal kuadriseps ve patellar tendonlar normaldir. Patella normal yerleşimlidir. Retinaküler devamsızlık yoktur.Eklemde sıvı artışı saptanmamıştır. Diz eklemini oluşturan kemik yapıların sinyal intensiteleri doğaldır.
```
